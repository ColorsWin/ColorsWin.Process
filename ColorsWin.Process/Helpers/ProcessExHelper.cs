...
namespace ColorsWin.Process.Helpers
{
    ...
    public class ProcessExHelper
    {
        ...
        public static void Run(int parentProcessId, string binaryPath, string commandLine = null)
        {
            ...
            bool ret = CreateProcess(binaryPath, commandLine, ref ps, ref ts, true, EXTENDED_STARTUPINFO_PRESENT | CREATE_NEW_CONSOLE, IntPtr.Zero, null, ref siEx, out pInfo);
